...
| Web vitals        | `@opentelemetry/instrumentation-browser/web-vitals` | [Reference](https://github.com/open-telemetry/opentelemetry-browser/blob/main/packages/instrumentation/README.md#web-vitals) |
