 ...
 * behaviour, and confirming the algorithm still matches. See the
 ...
 *   - positive if `a > b`
 *
 * Malformed values (anything that doesn't look like `1.2.3`) sort
 * as newer than anything known, which triggers the warning path —
 * better to flag an unfamiliar value than to guess.
 */
