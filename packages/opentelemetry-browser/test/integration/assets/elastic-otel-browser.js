...
(() => {
    ...
    function registerGlobal(type, instance, diag3, allowOverride) {
        ...
        var api = (_global[GLOBAL_OPENTELEMETRY_API_KEY] =
            (_a = _global[GLOBAL_OPENTELEMETRY_API_KEY]) !== null &&
            _a !== void 0
                ? _a
                : {
                      version: VERSION,
            ...
            function DiagAPI2() {
                ...
                var setLogger = function (logger2, optionsOrLogLevel) {
                    ...
                    var newLogger = createLogLevelDiagLogger(
                        (_b = optionsOrLogLevel.logLevel) !== null &&
                            _b !== void 0
                            ? _b
                            : DiagLogLevel.INFO,
                        logger2
                    ...
                    if (
                        oldLogger &&
                        !optionsOrLogLevel.suppressOverrideMessage
                    ) {
                        var stack =
    ...
    var baggageEntryMetadataSymbol = /* @__PURE__ */ Symbol(
    ...
    var NoopMeter =
        ...
        (function () {
            ...
            NoopMeter2.prototype.createUpDownCounter = function (
                _name,
                _options
            ) {
                return NOOP_UP_DOWN_COUNTER_METRIC;
            };
            NoopMeter2.prototype.createObservableGauge = function (
                _name,
                _options
            ) {
                return NOOP_OBSERVABLE_GAUGE_METRIC;
            };
            NoopMeter2.prototype.createObservableCounter = function (
                _name,
                _options
            ) {
    ...
    var NoopCounterMetric =
        ...
        (function (_super) {
            ...
            NoopCounterMetric2.prototype.add = function (
                _value,
                _attributes
            ) {};
    ...
    var NoopUpDownCounterMetric =
        ...
        (function (_super) {
            ...
            NoopUpDownCounterMetric2.prototype.add = function (
                _value,
                _attributes
            ) {};
    ...
    var NoopGaugeMetric =
        ...
        (function (_super) {
            ...
            NoopGaugeMetric2.prototype.record = function (
                _value,
                _attributes
            ) {};
    ...
    var NoopHistogramMetric =
        ...
        (function (_super) {
            ...
            NoopHistogramMetric2.prototype.record = function (
                _value,
                _attributes
            ) {};
    ...
    var NoopObservableMetric =
        ...
        (function () {
            ...
            NoopObservableMetric2.prototype.addCallback = function (
                _callback
            ) {};
            NoopObservableMetric2.prototype.removeCallback = function (
                _callback
            ) {};
    ...
    var NoopContextManager =
        ...
        (function () {
            ...
            NoopContextManager2.prototype.with = function (
                _context,
                fn,
                thisArg
            ) {
    ...
    var ContextAPI =
        ...
        (function () {
            ...
            ContextAPI2.prototype.setGlobalContextManager = function (
                contextManager
            ) {
    ...
    var NonRecordingSpan =
        ...
        (function () {
            ...
            NonRecordingSpan2.prototype.addEvent = function (
                _name,
                _attributes
            ) {
                return this;
    ...
    var NoopTextMapPropagator =
        ...
        (function () {
            ...
            NoopTextMapPropagator2.prototype.inject = function (
                _context,
                _carrier
            ) {};
    ...
    var PropagationAPI =
        ...
        (function () {
            ...
            PropagationAPI2.prototype.setGlobalPropagator = function (
                propagator
            ) {
                return registerGlobal(
                    API_NAME4,
    ...
    var ProxyLogger = class {
        ...
        _getLogger() {
            ...
            const logger2 = this._provider._getDelegateLogger(
                this.name,
                this.version,
                this.options
            );
    ...
    var ProxyLoggerProvider = class {
        getLogger(name, version, options) {
            var _a;
            return (_a = this._getDelegateLogger(name, version, options)) !==
                null && _a !== void 0
                ? _a
        ...
        _getDelegateLogger(name, version, options) {
            ...
            return (_a = this._delegate) === null || _a === void 0
                ? void 0
                : _a.getLogger(name, version, options);
        }
    };
    ...
    var GLOBAL_LOGS_API_KEY = /* @__PURE__ */ Symbol.for(
    ...
    var LogsAPI = class _LogsAPI {
        ...
        setGlobalLoggerProvider(provider) {
            ...
            _global2[GLOBAL_LOGS_API_KEY] = makeGetter(
        ...
        getLoggerProvider() {
            var _a, _b;
            return (_b =
                (_a = _global2[GLOBAL_LOGS_API_KEY]) === null || _a === void 0
                    ? void 0
                    : _a.call(
                          _global2,
                          API_BACKWARDS_COMPATIBILITY_VERSION
    ...
    function mergeOtlpSharedConfigurationWithDefaults(
    ...
    var SUPPRESS_TRACING_KEY = createContextKey(
    ...
    function getKeyPairs(baggage) {
        return baggage.getAllEntries().map(([key, value]) => {
            ...
            if (value.metadata !== void 0) {
                entry +=
                    BAGGAGE_PROPERTIES_SEPARATOR + value.metadata.toString();
            }
            return entry;
        });
    }
    ...
    var W3CBaggagePropagator = class {
        ...
        extract(context2, carrier, getter) {
            ...
            return propagation.setBaggage(
                context2,
                propagation.createBaggage(baggage)
            );
        }
        fields() {
    ...
    function millisToHrTime(epochMillis) {
        ...
        const nanos = Math.round(
            (epochMillis % 1e3) * MILLISECONDS_TO_NANOSECONDS
        );
        ...
        constructor(config = {}) {
            ...
            this._fields = Array.from(
                new Set(
                    this._propagators
                        .map((p) =>
                            typeof p.fields === 'function' ? p.fields() : []
                        )
    ...
    var BindOnceFuture = class {
        ...
        call(...args) {
            if (!this._isCalled) {
                ...
                try {
                    Promise.resolve(
                        this._callback.call(this._that, ...args)
                    ).then(
                            ...
                            if (response.data != null) {
                                try {
                                    this._responseHandler.handleResponse(
                                        this._serializer.deserializeResponse(
                                            response.data
                                        )
                                    );
                                } catch (e) {
    ...
    function hrTimeToNanos(hrTime3) {
        ...
        return (
            BigInt(Math.trunc(hrTime3[0])) * NANOSECONDS +
            BigInt(Math.trunc(hrTime3[1]))
        );
    }
            ...
            return {
                ...
                scopeLogs: Array.from(ismMap, ([, scopeLogs]) => {
                    return {
                        ...
                        logRecords: scopeLogs.map((log) =>
                            toLogRecord(log, encoder)
                        ),
    ...
    (function (AggregationTemporality2) {
        AggregationTemporality2[(AggregationTemporality2['DELTA'] = 0)] =
            'DELTA';
        AggregationTemporality2[(AggregationTemporality2['CUMULATIVE'] = 1)] =
            'CUMULATIVE';
    ...
    (function (InstrumentType2) {
        ...
        InstrumentType2['OBSERVABLE_UP_DOWN_COUNTER'] =
            'OBSERVABLE_UP_DOWN_COUNTER';
    })(InstrumentType || (InstrumentType = {}));
    var DataPointType;
    (function (DataPointType2) {
        DataPointType2[(DataPointType2['HISTOGRAM'] = 0)] = 'HISTOGRAM';
        DataPointType2[(DataPointType2['EXPONENTIAL_HISTOGRAM'] = 1)] =
    ...
    (function (AggregatorKind2) {
        ...
        AggregatorKind2[(AggregatorKind2['EXPONENTIAL_HISTOGRAM'] = 4)] =
            'EXPONENTIAL_HISTOGRAM';
                ...
                dataPoints: accumulationByAttributes.map(
                    ([attributes, accumulation]) => {
                        ...
                        return {
                            ...
                            endTime,
                            value: {
                                min: pointValue.hasMinMax
                                    ? pointValue.min
                                    : void 0,
                                max: pointValue.hasMinMax
                                    ? pointValue.max
                                    : void 0,
                                sum: !allowsNegativeValues
                                    ? pointValue.sum
                                    : void 0,
    ...
    var BucketsBacking = class _BucketsBacking {
        ...
        growTo(newSize, oldPositiveLimit, newPositiveLimit) {
            ...
            tmp.splice(
                0,
                oldPositiveLimit,
                ...this._counts.slice(0, oldPositiveLimit)
            );
            this._counts = tmp;
        }
        /**
            ...
            if (index >= maxIndex) {
                if (index === maxIndex) {
                    return (
                        2 *
                        Math.exp(
                            (index - (1 << this._scale)) / this._scaleFactor
                        )
                    );
                }
                throw new MappingError(
    ...
    var HighLow = class _HighLow {
        ...
        static combine(h1, h2) {
            return new _HighLow(
                Math.min(h1.low, h2.low),
                Math.max(h1.high, h2.high)
            );
        }
    ...
    var ExponentialHistogramAccumulation = class _ExponentialHistogramAccumulation {
        ...
        constructor(
            ...
            if (this._maxSize < MIN_MAX_SIZE) {
                diag2.warn(
                    `Exponential Histogram Max Size set to ${this._maxSize},                 changing to the minimum size of: ${MIN_MAX_SIZE}`
                );
         ...
         */
        clone() {
            return new _ExponentialHistogramAccumulation(
                this.startTime,
                this._maxSize,
                this._recordMinMax,
                this._sum,
        ...
        _highLowAtScale(buckets, currentScale, newScale) {
            ...
            return new HighLow(
                buckets.indexStart >> shift,
                buckets.indexEnd >> shift
            );
        }
        /**
                        ...
                        return {
                            ...
                            value: {
                                ...
                                positive: {
                                    ...
                                    bucketCounts:
                                        pointValue.positive.bucketCounts,
                                },
                                negative: {
                                    offset: pointValue.negative.offset,
                                    bucketCounts:
                                        pointValue.negative.bucketCounts,
                                },
                                count: pointValue.count,
    ...
    var HistogramAggregation = class _HistogramAggregation {
        static DEFAULT_INSTANCE = new HistogramAggregator(
            [
                0, 5, 10, 25, 50, 75, 100, 250, 500, 750, 1e3, 2500, 5e3, 7500,
                1e4,
            ],
            true
        );
    ...
    var ExplicitBucketHistogramAggregation = class {
        ...
        constructor(boundaries, _recordMinMax = true) {
            ...
            this._boundaries = boundaries.slice(
                minusInfinityIndex + 1,
                infinityIndex
            );
        }
        createAggregator(_instrument) {
    ...
    var DefaultAggregation = class {
        _resolve(instrument) {
            ...
            diag2.warn(
                `Unable to recognize instrument type: ${instrument.type}`
            );
    ...
    var EXPONENTIAL_HISTOGRAM_AGGREGATION =
    ...
    (function (AggregationType2) {
        ...
        AggregationType2[(AggregationType2['EXPLICIT_BUCKET_HISTOGRAM'] = 4)] =
            'EXPLICIT_BUCKET_HISTOGRAM';
        AggregationType2[(AggregationType2['EXPONENTIAL_HISTOGRAM'] = 5)] =
            'EXPONENTIAL_HISTOGRAM';
    ...
    var DEFAULT_AGGREGATION_TEMPORALITY_SELECTOR = (_instrumentType) =>
    ...
    var MetricReader = class {
        ...
        async forceFlush(options) {
            if (this._shutdown) {
                diag2.warn(
                    'Cannot forceFlush on already shutdown MetricReader.'
                );
                return;
            }
            if (options?.timeoutMillis == null) {
    ...
    var PeriodicExportingMetricReader = class extends MetricReader {
        ...
        constructor(options) {
            super({
                ...
                aggregationTemporalitySelector:
                    options.exporter.selectAggregationTemporality?.bind(
                        options.exporter
                    ),
                metricProducers: options.metricProducers,
            });
            if (
                options.exportIntervalMillis !== void 0 &&
                options.exportIntervalMillis <= 0
            ) {
                throw Error('exportIntervalMillis must be greater than 0');
            }
            if (
                options.exportTimeoutMillis !== void 0 &&
        ...
        async _doRun() {
            ...
            const result = await internal._export(
                this._exporter,
                resourceMetrics
            );
    ...
    function mergeSchemaUrl(old, updating) {
        ...
        const isUpdatingEmpty =
            updatingSchemaUrl === void 0 || updatingSchemaUrl === '';
        if (isOldEmpty) {
    ...
    var ViewRegistry = class {
        ...
        findViews(instrument, meter) {
            const views = this._registeredViews.filter((registeredView) => {
                return (
                    this._matchInstrument(
                        registeredView.instrumentSelector,
                        instrument
    ...
    var Meter = class {
        ...
        createGauge(name, options) {
            ...
            const storage =
                this._meterSharedState.registerMetricStorage(descriptor);
    ...
    var DeltaMetricProcessor = class {
        ...
        record(value, attributes, _context, collectionTime) {
            ...
            if (!accumulation) {
                if (
                    this._activeCollectionStorage.size >= this._cardinalityLimit
                ) {
                    const overflowAccumulation =
                        this._activeCollectionStorage.getOrDefault(
                            this._overflowAttributes,
                            () =>
                                this._aggregator.createAccumulation(
                                    collectionTime
                                )
                        );
            ...
            Array.from(measurements.entries()).forEach(
                ([attributes, value, hashCode]) => {
                    ...
                    if (this._cumulativeMemoStorage.has(attributes, hashCode)) {
                        ...
                        if (
                            this._cumulativeMemoStorage.size >=
                            this._cardinalityLimit
                        ) {
                            attributes = this._overflowAttributes;
                            hashCode = this._overflowHashCode;
                            if (
                                this._cumulativeMemoStorage.has(
                                    attributes,
                                    hashCode
                                )
                            ) {
                                const previous =
                                    this._cumulativeMemoStorage.get(
                                        attributes,
                                        hashCode
                                    );
                                delta = this._aggregator.diff(
                                    previous,
                                    accumulation
                                );
                            }
                    ...
                    if (
                        this._activeCollectionStorage.has(attributes, hashCode)
                    ) {
                    ...
                    this._cumulativeMemoStorage.set(
                        attributes,
                        accumulation,
                        hashCode
                    );
                    this._activeCollectionStorage.set(
                        attributes,
                        delta,
                        hashCode
                    );
        ...
        buildMetrics(
            ...
            if (this._reportHistory.has(collector)) {
                ...
                if (
                    ...
                    result = _TemporalMetricProcessor.merge(
                        last.accumulations,
                        unreportedAccumulations,
                        this._aggregator
                    );
                } else {
                    result = _TemporalMetricProcessor.calibrateStartTime(
                        last.accumulations,
                        unreportedAccumulations,
                        lastCollectionTime
                    );
        ...
        static merge(last, current, aggregator) {
            ...
            while (next.done !== true) {
                ...
                if (last.has(key, hash)) {
                    ...
                    const accumulation = aggregator.merge(
                        lastAccumulation,
                        record
                    );
    ...
    var AsyncMetricStorage = class extends MetricStorage {
        ...
        record(measurements, observationTime) {
            ...
            Array.from(measurements.entries()).forEach(
                ([attributes, value]) => {
                    processed.set(
                        this._attributesProcessor.process(attributes),
                        value
                    );
                }
            );
...
`;
    ...
    function getConflictResolutionRecipe(existing, otherDescriptor) {
        if (existing.valueType !== otherDescriptor.valueType) {
            return getValueTypeConflictResolutionRecipe(
                existing,
                otherDescriptor
            );
        }
    ...
    var MetricStorageRegistry = class _MetricStorageRegistry {
        ...
        getStorages(collector) {
            ...
            const perCollectorStorages =
                this._perCollectorRegistry.get(collector);
        ...
        findOrUpdateCompatibleStorage(expectedDescriptor) {
            ...
            return this._findOrUpdateCompatibleStorage(
                expectedDescriptor,
                storages
            );
        }
        ...
        _findOrUpdateCompatibleStorage(expectedDescriptor, existingStorages) {
            ...
            for (const existingStorage of existingStorages) {
                const existingDescriptor =
                    existingStorage.getInstrumentDescriptor();
                if (
    ...
    var ObservableRegistry = class {
        ...
        addBatchCallback(callback, instruments) {
            ...
            const idx = this._findBatchCallback(
                callback,
    ...
    var SyncMetricStorage = class extends MetricStorage {
        ...
        record(value, attributes, context2, recordTime) {
            ...
            this._deltaMetricStorage.record(
                value,
                attributes,
                context2,
                recordTime
    ...
    var MultiAttributesProcessor = class {
        ...
        process(incoming, context2) {
            ...
            for (const processor of this._processors) {
                filteredAttributes = processor.process(
                    filteredAttributes,
                    context2
                );
            }
        ...
        _registerMetricStorage(descriptor, MetricStorageType) {
            ...
            let storages = views.map((view) => {
                ...
                const compatibleStorage =
                    this.metricStorageRegistry.findOrUpdateCompatibleStorage(
                        viewDescriptor
                    );
                ...
                const aggregator =
                    view.aggregation.createAggregator(viewDescriptor);
            ...
            if (storages.length === 0) {
                ...
                const collectorStorages = perCollectorAggregations.map(
                    ([collector, aggregation]) => {
                        ...
                        const aggregator =
                            aggregation.createAggregator(descriptor);
                        const cardinalityLimit =
                            collector.selectCardinalityLimit(descriptor.type);
                        ...
                        this.metricStorageRegistry.registerForCollector(
                            collector,
                            storage
                        );
                        return storage;
    ...
    var MetricCollector = class {
        ...
        selectAggregationTemporality(instrumentType) {
            return this._metricReader.selectAggregationTemporality(
                instrumentType
            );
        }
        selectAggregation(instrumentType) {
        ...
        selectCardinalityLimit(instrumentType) {
            return (
                this._metricReader.selectCardinalityLimit?.(instrumentType) ??
                2e3
            );
        }
    };
        ...
        constructor(pattern) {
            if (pattern === '*') {
                ...
                this._regexp = new RegExp(
                    _PatternPredicate.escapePattern(pattern)
                );
            }
        }
        match(str) {
    ...
    var View = class {
        ...
        constructor(viewOptions) {
            ...
            this.aggregationCardinalityLimit =
        ...
        constructor(options) {
            ...
            if (options?.views != null && options.views.length > 0) {
                for (const viewOption of options.views) {
                    this._sharedState.viewRegistry.addView(
                        new View(viewOption)
                    );
                }
            }
    ...
    (function (EAggregationTemporality2) {
        EAggregationTemporality2[
            (EAggregationTemporality2['AGGREGATION_TEMPORALITY_UNSPECIFIED'] =
                0)
        ] = 'AGGREGATION_TEMPORALITY_UNSPECIFIED';
        EAggregationTemporality2[
            (EAggregationTemporality2['AGGREGATION_TEMPORALITY_DELTA'] = 1)
        ] = 'AGGREGATION_TEMPORALITY_DELTA';
        EAggregationTemporality2[
            (EAggregationTemporality2['AGGREGATION_TEMPORALITY_CUMULATIVE'] = 2)
    ...
    function toScopeMetrics(scopeMetrics, encoder) {
        return Array.from(
            scopeMetrics.map((metrics2) => ({
                scope: createInstrumentationScope(metrics2.scope),
                metrics: metrics2.metrics.map((metricData) =>
        ...
        switch (metricData.dataPointType) {
            ...
            case DataPointType.EXPONENTIAL_HISTOGRAM:
                out.exponentialHistogram = {
                    aggregationTemporality,
                    dataPoints: toExponentialHistogramDataPoints(
                        metricData,
                        encoder
                    ),
                };
    ...
    function createExportMetricsServiceRequest(resourceMetrics, options) {
        return {
            resourceMetrics: resourceMetrics.map((metrics2) =>
                toResourceMetrics(metrics2, options)
            ),
        };
    }
    ...
    function convertLegacyBrowserHttpOptions(
        config,
        signalResourcePath,
        requiredHeaders
    ) {
    ...
    function createLegacyOtlpBrowserExportDelegate(
        ...
        const createOtlpExportDelegate2 = inferExportDelegateToUse(
            config.headers
        );
    ...
    (function (AggregationTemporalityPreference2) {
        AggregationTemporalityPreference2[
            (AggregationTemporalityPreference2['DELTA'] = 0)
        ] = 'DELTA';
        AggregationTemporalityPreference2[
            (AggregationTemporalityPreference2['CUMULATIVE'] = 1)
        ] = 'CUMULATIVE';
        AggregationTemporalityPreference2[
            (AggregationTemporalityPreference2['LOWMEMORY'] = 2)
        ] = 'LOWMEMORY';
    })(
    ...
    var LogRecordImpl = class {
        ...
        _truncateToSize(value) {
            ...
            if (limit <= 0) {
                diag2.warn(
                    `Attribute value limit must be positive, got ${limit}`
                );
                return value;
            }
            ...
            if (Array.isArray(value)) {
                return value.map((val) =>
                    typeof val === 'string'
                        ? this._truncateToLimitUtil(val, limit)
                        : val
                );
            }
            return value;
    ...
    var Logger = class {
        ...
        emit(logRecord) {
            ...
            this._sharedState.activeProcessor.onEmit(
                logRecordInstance,
                currentContext
            );
    ...
    var MultiLogRecordProcessor = class {
        ...
        onEmit(logRecord, context2) {
            this.processors.forEach((processors) =>
                processors.onEmit(logRecord, context2)
            );
        }
        async shutdown() {
            await Promise.all(
    ...
    var LoggerProvider = class {
        ...
        getLogger(name, version, options) {
            ...
            if (!name) {
                diag2.warn(
                    'Logger requested without instrumentation scope name.'
                );
            }
    ...
    var BatchLogRecordProcessorBase = class {
        ...
        _flushOneBatch() {
            ...
            return new Promise((resolve, reject) => {
                callWithTimeout(
                    this._export(
                        this._finishedLogRecords.splice(
                            0,
                            this._maxExportBatchSize
                        )
                    ),
    ...
    var SpanImpl = class {
        ...
        recordException(exception, time) {
            ...
            if (
                attributes[ATTR_EXCEPTION_TYPE] ||
                attributes[ATTR_EXCEPTION_MESSAGE]
            ) {
            ...
            return {
                decision:
                    ...
                    this._accumulate(traceId) < this._upperBound
                        ? SamplingDecision2.RECORD_AND_SAMPLED
                        : SamplingDecision2.NOT_RECORD,
            };
        }
        toString() {
    ...
    (function (TracesSamplerValues2) {
        ...
        TracesSamplerValues2['ParentBasedTraceIdRatio'] =
    ...
    function loadDefaultConfig2() {
        return {
            ...
            spanLimits: {
                ...
                linkCountLimit:
                    getNumberFromEnv('OTEL_SPAN_LINK_COUNT_LIMIT') ?? 128,
                eventCountLimit:
                    getNumberFromEnv('OTEL_SPAN_EVENT_COUNT_LIMIT') ?? 128,
        ...
        constructor(_exporter, config) {
            ...
            this._maxExportBatchSize =
                typeof config?.maxExportBatchSize === 'number'
                    ? config.maxExportBatchSize
                    : (getNumberFromEnv('OTEL_BSP_MAX_EXPORT_BATCH_SIZE') ??
                      512);
            this._maxQueueSize =
            ...
            this._scheduledDelayMillis =
                typeof config?.scheduledDelayMillis === 'number'
                    ? config.scheduledDelayMillis
                    : (getNumberFromEnv('OTEL_BSP_SCHEDULE_DELAY') ?? 5e3);
            this._exportTimeoutMillis =
                typeof config?.exportTimeoutMillis === 'number'
                    ? config.exportTimeoutMillis
                    : (getNumberFromEnv('OTEL_BSP_EXPORT_TIMEOUT') ?? 3e4);
            this._shutdownOnce = new BindOnceFuture(this._shutdown, this);
            if (this._maxExportBatchSize > this._maxQueueSize) {
                diag2.warn(
            ...
            return new Promise((resolve, reject) => {
                ...
                context.with(suppressTracing(context.active()), () => {
                    ...
                    if (
                        ...
                        spans = this._finishedSpans.splice(
                            0,
                            this._maxExportBatchSize
                        );
                    }
    ...
    function getIdGenerator(bytes) {
        return function generateId() {
            for (let i = 0; i < bytes * 2; i++) {
                SHARED_CHAR_CODES_ARRAY[i] =
                    Math.floor(Math.random() * 16) + 48;
    ...
    (function (PerformanceTimingNames2) {
        ...
        PerformanceTimingNames2['DOM_CONTENT_LOADED_EVENT_END'] =
            'domContentLoadedEventEnd';
        PerformanceTimingNames2['DOM_CONTENT_LOADED_EVENT_START'] =
        ...
        PerformanceTimingNames2['SECURE_CONNECTION_START'] =
    ...
    var ATTR_HTTP_RESPONSE_CONTENT_LENGTH_UNCOMPRESSED =
    ...
    function addSpanNetworkEvents(
        ...
        if (!skipOldSemconvContentLengthAttrs) {
            const encodedLength =
                resource[PerformanceTimingNames.ENCODED_BODY_SIZE];
            ...
            const decodedLength =
                resource[PerformanceTimingNames.DECODED_BODY_SIZE];
    ...
    function getResource(
        ...
        if (parsedSpanUrl.origin !== getOrigin() && sorted.length > 1) {
            ...
            let mainRequest = findMainRequest(
                sorted,
    ...
    function shouldPropagateTraceHeaders(
        spanUrl,
    ...
    var getPerformanceNavigationEntries = () => {
        ...
        const performanceNavigationTiming =
            otperformance.getEntriesByType?.('navigation')[0];
    ...
    var addSpanPerformancePaintEvents = (span) => {
        const performancePaintTiming =
            otperformance.getEntriesByType?.('paint');
                    ...
                    context.with(
                        ...
                        () => {
                            ...
                            if (fetchSpan) {
                                ...
                                context.with(
                                    trace.setSpan(context.active(), fetchSpan),
                                    () => {
    ...
    var ATTR_HTTP_REQUEST_CONTENT_LENGTH_UNCOMPRESSED =
    ...
    function getFetchBodyLength(...args) {
        if (args[0] instanceof URL || typeof args[0] === 'string') {
            ...
            if (requestInit.body instanceof ReadableStream) {
                const {body, length} = _getBodyNonDestructively(
                    requestInit.body
                );
    ...
    function _getBodyNonDestructively(body) {
        if (!body.pipeThrough) {
            DIAG_LOGGER.warn(
                'Platform has ReadableStream but not pipeThrough!'
            );
            return {
                body,
    ...
    function serverPortFromUrl(url) {
        const serverPort = Number(
            url.port || HTTP_PORT_FROM_PROTOCOL[url.protocol]
        );
    ...
    var FetchInstrumentation = class extends InstrumentationBase {
        ...
        _addFinalSpanAttributes(span, response) {
            ...
            if (this._semconvStability & SemconvStability.OLD) {
                ...
                if (response.statusText != null) {
                    span.setAttribute(
                        AttributeNames2.HTTP_STATUS_TEXT,
                        response.statusText
                    );
                }
        ...
        _createSpan(url, options = {}) {
            ...
            if (this._semconvStability & SemconvStability.STABLE) {
                ...
                const normMethod = normalizeHttpRequestMethod(
                    options.method || 'GET'
                );
                if (!name) {
                    name = normMethod;
        ...
        _endSpan(span, spanData, response) {
            ...
            setTimeout(() => {
                ...
                this._findResourceAndAddNetworkEvents(
                    span,
                    spanData,
                    performanceEndTime
                );
        ...
        _patchConstructor() {
            return (original) => {
                ...
                return function patchConstructor(...args) {
                    ...
                    const options =
                        args[0] instanceof Request ? args[0] : args[1] || {};
                            ...
                            () => {
                                ...
                                return original
                                    ...
                                    .then(
                                        ...
                                        onError.bind(self2, createdSpan, reject)
                                    );
                            }
                        );
                    });
        ...
        _createSpanFromEntry(entry) {
            ...
            if (observerCallback) {
                try {
                    ...
                    diag2.error(
                        'longtask instrumentation: observer callback failed',
                        err
                    );
                }
            }
        ...
        enable() {
            ...
            this._observer = new PerformanceObserver((list) => {
                list.getEntries().forEach((entry) =>
                    this._createSpanFromEntry(entry)
                );
            });
    ...
    var UserInteractionInstrumentation = class extends InstrumentationBase {
        ...
        constructor(config = {}) {
            ...
            this._eventNames = new Set(
                config?.eventNames ?? DEFAULT_EVENT_NAMES
            );
        ...
        _patchZoneCancelTask() {
            ...
            return (original) => {
                return function patchCancelTask(task) {
                    ...
                    if (
                        currentSpan &&
                        plugin._shouldCountTask(task, currentZone)
                    ) {
        ...
        _patchZoneRunTask() {
            ...
            return (original) => {
                return function patchRunTask(task, applyThis, applyArgs) {
                    const event =
                        Array.isArray(applyArgs) &&
                        applyArgs[0] instanceof Event
                            ? applyArgs[0]
                            : void 0;
                    const target = event?.target;
                    let span;
        ...
        enable() {
            ...
            if (ZoneWithPrototype) {
                if (isWrapped(ZoneWithPrototype.prototype.runTask)) {
                    ...
                    this._diag.debug(
                        'removing previous patch from method runTask'
                    );
                }
    ...
    var ATTR_HTTP_REQUEST_CONTENT_LENGTH_UNCOMPRESSED2 =
        'http.request_content_length_uncompressed';
    ...
    function serverPortFromUrl2(url) {
        const serverPort = Number(
            url.port || HTTP_PORT_FROM_PROTOCOL2[url.protocol]
        );
        if (serverPort && !isNaN(serverPort)) {
            return serverPort;
        } else {
        ...
        _addFinalSpanAttributes(span, xhrMem, spanUrl) {
            if (this._semconvStability & SemconvStability.OLD) {
                ...
                if (xhrMem.statusText !== void 0) {
                    span.setAttribute(
                        AttributeNames4.HTTP_STATUS_TEXT,
                        xhrMem.statusText
                    );
                }
            ...
            return (original) => {
                return function patchSend(...args) {
                    ...
                    if (currentSpan && spanUrl) {
                        if (
                            plugin.getConfig().measureRequestSize &&
                            args?.[0]
                        ) {
                            const body = args[0];
                            ...
                            if (bodyLength !== void 0) {
                                if (
                                    ...
                                    currentSpan.setAttribute(
                                        ATTR_HTTP_REQUEST_CONTENT_LENGTH_UNCOMPRESSED2,
                                        bodyLength
                                    );
                                }
                                if (
    ...
    var MILLISECONDS_TO_NANOSECONDS2 = Math.pow(
        10,
        NANOSECOND_DIGITS_IN_MILLIS2
    );
    ...
    function millisToHrTime2(epochMillis) {
        ...
        var nanos = Math.round(
            (epochMillis % 1e3) * MILLISECONDS_TO_NANOSECONDS2
        );
        return [seconds, nanos];
    }
    ...
    function startBrowserSdk(cfg = {}) {
        ...
        diag2.setLogger(createLogger({logLevel}), {logLevel: DiagLogLevel.ALL});
